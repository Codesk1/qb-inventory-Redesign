...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        if (data.other != null && data.other != "") {
            $('#other-inv-weight').fadeIn();
            $('.other-inventory').fadeIn();
            $('.other-inv-info').fadeIn();
            $("#other-inv-label").fadeIn();
            $('.player-inventory').css('top', '20%')
            $('.inv-options').css('top', '12%')
            $('.player-inv-info').css('top', '12.7%')
            $('.ply-iteminfo-container').css('top', '11.6%')
            $(".other-inventory").attr("data-inventory", data.other.name);
        } else {
            $('#other-inv-weight').fadeOut();
            $('.other-inventory').fadeOut();
            $("#other-inv-label").fadeOut();
            $('.other-inv-info').fadeOut();
            $('.ply-iteminfo-container').css('top', '25.5%')
    ...
    Inventory.Close = function() {
        $('#other-inv-weight').fadeOut();
        $('.player-inventory').css('top', '35%')
        $('.inv-options').css('top', '27%')
        $('.player-inv-info').css('top', '28%')
        $('.other-inv-info').fadeOut();
        $('.ply-iteminfo-container').css('top', '25.5%')
        $('.other-inventory').fadeOut();
        $("#other-inv-label").fadeOut();
